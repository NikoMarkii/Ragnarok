...
public class GradiusGreatSword extends SwordItem implements GeoItem {
    ...
    public GradiusGreatSword(Properties properties) {
        ...
        GeoItem.registerSyncedAnimatable(this); // ← これも追加
    }
    ...
    public void initializeClient(java.util.function.Consumer<net.minecraftforge.client.extensions.common.IClientItemExtensions> consumer) {
        consumer.accept(new net.minecraftforge.client.extensions.common.IClientItemExtensions() {
            private GradiusGreatSwordRenderer renderer;

            @Override
            public software.bernie.geckolib.renderer.GeoItemRenderer<?> getCustomRenderer() {
                if (renderer == null) {
                    renderer = new GradiusGreatSwordRenderer();
                }
                return renderer;
            }
        });
