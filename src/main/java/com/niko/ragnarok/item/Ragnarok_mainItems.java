...
public class Ragnarok_mainItems {
    ...
    public static final RegistryObject<Item> GHOST_SPAWN_EGG = ITEMS.register("ghost_spawn_egg",
            () -> new ForgeSpawnEggItem(
                    RagnarokEntities.GHOST,
                    0x00bfff,
                    0x6495ed,
                    new Item.Properties()
            ));
    public static final RegistryObject<Item> GHOST_KNIGHT_SPAWN_EGG = ITEMS.register("ghost_knight_spawn_egg",
            () -> new ForgeSpawnEggItem(
                    RagnarokEntities.GHOST_KNIGHT,
                    0x696969,
                    0x000000,
                    new Item.Properties()
            ));
    ...
    public static final RegistryObject<Item> GRADIUS_GREAT_SWORD =
            ITEMS.register("gradius_great_sword",
                    () -> new GradiusGreatSword(new Item.Properties()
                            .stacksTo(1)
                            .rarity(Rarity.RARE)
                            .fireResistant()));
