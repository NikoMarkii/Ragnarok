...
public class RagnarokEventBusClientEvent {
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(RagnarokEntities.CASSOWARY.get(), CassowaryRenderer::new);
        event.registerEntityRenderer(RagnarokEntities.GRADIUS.get(), GradiusRenderer::new);
        event.registerEntityRenderer(RagnarokEntities.GHOST.get(), GhostRenderer::new);
        event.registerEntityRenderer(RagnarokEntities.GHOST_KNIGHT.get(), GhostKnightRenderer::new);
