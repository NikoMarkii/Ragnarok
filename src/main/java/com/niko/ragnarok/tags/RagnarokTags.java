...
public class RagnarokTags {
    public static class Blocks {
        ...
        private static TagKey<Block> tag(String name) {
            return BlockTags.create(ResourceLocation.fromNamespaceAndPath(Ragnarok.MOD_ID, name));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> tag(String name) {
            return ItemTags.create(ResourceLocation.fromNamespaceAndPath(Ragnarok.MOD_ID, name));
        }
    }
}